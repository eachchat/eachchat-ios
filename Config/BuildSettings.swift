...
//        "www.example.com": ["/"],
    ...
    // MARK: - Bug report
    static let bugReportEndpointUrlString = "https://github.com/eachchat/eachchat-ios/issues"
    // Use the name allocated by the bug report server
    static let bugReportApplicationId = "eachchat"
    ...
    static let jitsiServerUrl: URL? = URL(string: "https://jitsi.yunify.com")
    ...
    static var isRoomScreenEnableMessageBubblesByDefault: Bool {
        ...
        return self.roomScreenTimelineDefaultStyleIdentifier == .plain
    }
